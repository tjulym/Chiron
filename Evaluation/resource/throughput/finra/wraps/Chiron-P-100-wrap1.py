...
Pools = ProcessPoolExecutor(max_workers=100)
...
def handle(req):
	...
	ps = []	
	indexs = [1, 4, 2, 5, 3, 6, 9, 7, 10, 8, 11, 14, 12, 15, 13, 16, 19, 17, 20, 18, 0, 3, 1, 4, 2, 5, 8, 6, 9, 7, 10, 13, 11, 14, 12, 15, 18, 16, 19, 17, 20, 2, 0, 3, 1, 4, 7, 5, 8, 6, 9, 12, 10, 13, 11, 14, 17, 15, 18, 16, 19, 1, 20, 2, 0, 3, 6, 4, 7, 5, 8, 11, 9, 12, 10, 13, 16, 14, 17, 15, 18, 0, 19, 1, 20, 2, 5, 3, 6, 4, 7, 10, 8, 11, 9, 12, 15, 13, 16, 14]
	base_funcs = [marketdata, trddate, lastpx, volume, side]
	funcs = []
	for i in range(5):
		funcs.extend([base_funcs[i]]*20)
