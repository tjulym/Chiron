...
def handle(req):
	...
	ts = []
	ts.append(MyThread(remote, args=(2, req)))
	ts[0].start()

	ps = []
	parent_conns = []

	ps_fss = [[marketdata, marketdata, marketdata, marketdata, trddate, trddate, trddate, lastpx, lastpx, lastpx, lastpx, lastpx, volume, volume, volume, side, side, side, side], [marketdata, marketdata, marketdata, marketdata, trddate, trddate, trddate, trddate, trddate, trddate, trddate, lastpx, lastpx, lastpx, lastpx, lastpx, volume, side], [marketdata, marketdata, marketdata, marketdata, trddate, trddate, trddate, trddate, trddate, lastpx, lastpx, side, side, side, side, side, side, side], [marketdata, marketdata, marketdata, volume, volume, volume, volume, volume, volume, volume, volume, volume, volume, volume, volume, volume, volume, volume], [marketdata, marketdata, marketdata, lastpx, volume, volume, volume, volume, side, side, side, side, side, side, side, side, side, side]]
	...
	main_fs = [marketdata, marketdata, marketdata, trddate, trddate, trddate, trddate, trddate, trddate, lastpx, lastpx, lastpx, lastpx, lastpx, lastpx, lastpx, lastpx, volume, side]
	for f in main_fs:
