...
def handle(req):
	...
	ps_fss = [[marketdata, marketdata, marketdata, marketdata, trddate, trddate, trddate, lastpx, lastpx, lastpx, lastpx, side, side, side, side, side, side], [marketdata, marketdata, marketdata, marketdata, volume, volume, volume, volume, volume, volume, volume, volume, volume, volume, volume, volume], [marketdata, marketdata, marketdata, trddate, trddate, trddate, trddate, lastpx, lastpx, lastpx, volume, volume, volume, volume, side, side, side], [marketdata, marketdata, marketdata, trddate, trddate, trddate, lastpx, lastpx, lastpx, volume, volume, volume, volume, side, side, side], [marketdata, marketdata, marketdata, trddate, trddate, trddate, trddate, lastpx, lastpx, lastpx, side, side, side, side, side, side, side],]
	...
	main_fs = [marketdata, marketdata, marketdata, trddate, trddate, trddate, trddate, trddate, trddate, lastpx, lastpx, lastpx, lastpx, lastpx, lastpx, lastpx, side]
	for f in main_fs:
