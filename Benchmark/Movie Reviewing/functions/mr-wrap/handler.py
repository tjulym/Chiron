...
def handle(req):
	...
	ps = []	
	for i, f in enumerate([upload_movie_id, upload_user_id, mr_upload_unique_id, mr_upload_text]):
	...
	ps = []
	for i, f in enumerate([upload_movie_review, upload_user_review, store_review]):
