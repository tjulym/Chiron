...
# THREAD_BLOCK = 0.6
THREAD_BLOCK = 7
# THREAD_BLOCK = 13 # FINRA-200
# THREAD_INIT = 0.8
THREAD_INIT = 13 
# THREAD_INIT = 24 # FINRA-200
...
def get_timeline(func_name):
    global GOLBAL_DATA
    if func_name in GOLBAL_DATA:
        return GOLBAL_DATA[func_name][0], copy.deepcopy(GOLBAL_DATA[func_name][1])
    ...
    GOLBAL_DATA[func_name] = (lat, timelines)
