...
import itertools
import copy
from predictor import predict, get_sorted_fs, FUNC_EXEC_TIMES
...
def get_latency_from_partitions(partitions, task_fn_mp):
    indexes = get_sorted_fs(partitions, task_fn_mp)

    latency = predict(partitions, task_fn_mp, indexes)
    return latency
...
def KL_graph_partition(fs, task_fn_mp, num_partitions=2, partitions=None):
    ...
    best_latency = get_latency_from_partitions(partitions, task_fn_mp)
...
if __name__ == '__main__':
    print(schedule('{"workflow": "sn", "SLO": 40}'))
    # print(schedule('{"workflow": "mr", "SLO": 40}'))
    # print(schedule('{"workflow": "finra5", "SLO": 100}'))
    # print(schedule('{"workflow": "finra50", "SLO": 133}'))
    # print(schedule('{"workflow": "finra100", "SLO": 168}'))
    # print(schedule('{"workflow": "finra200", "SLO": 241}'))
    # print(schedule('{"workflow": "SLApp", "SLO": 80}'))
    # print(schedule('{"workflow": "SLApp-V", "SLO": 100}'))